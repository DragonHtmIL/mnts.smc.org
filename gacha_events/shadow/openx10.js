function summonshadowTen() {
  ...
  if (crystal < 150 && ticketPremium < 10) {
    document.getElementById("opshadowbtnTen").classList.add("null");
    setTimeout( function() {
      document.getElementById("opshadowbtnTen").classList.remove("null");
    },1000);
    cancelSound();
    return;
  }
