function eventId00000000() {
  ...
  content.setAttribute("style", "background-image: url('https://dragonhtmil.github.io/mnts.smc.org/gacha_events/shadow/image_shadow_watcher.png');");
  ...
  window.addEventListener('offline', function() {
    ...
    skin1.removeChild(mecha1);
    mecha1.removeChild(img1);
    mecha1.removeChild(rank1);
    mecha1.removeChild(name1);
    mecha1.removeChild(effect1);
