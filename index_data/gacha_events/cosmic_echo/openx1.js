function summoncosmicOne() {
  ...
  if (crystal < 15 && ticketPremium < 1) {
    document.getElementById("opcosmicbtnOne").classList.add("null");
    setTimeout( function() {
      document.getElementById("opcosmicbtnOne").classList.remove("null");
    },1000);
    cancelSound();
    return;
  }
