...
//  const win3 = document.getElementById("");
  ...
  const win8 = document.getElementById("userModal");
...
const initGame = () => {
  ...
  if(snakeX === foodX && snakeY === foodY) {
    ...
    if(localStorage.getItem("foodStyle") === "imgMeow") {
      meaw_token_item = getStoredNumber("meawTokenStorage");
      meaw_token_item++;
    ...
    if(localStorage.getItem("foodStyle") === "imgGold") {
      gold_item = getStoredNumber("goldStorage");
      gold_item++;
    ...
    if(localStorage.getItem("foodStyle") === "imgAlphacoin") {
      alpha_coin_item = getStoredNumber("alphaCoinStorage");
      alpha_coin_item++;
    ...
    if(localStorage.getItem("foodStyle") === "imgCrystal") {
      crystal_item = getStoredNumber("crystalStorage");
      crystal_item++;
    ...
    if(localStorage.getItem("foodStyle") === "imgVirtualToken") {
      virtual_Token_item = getStoredNumber("virtualTokenStorage");
      virtual_Token_item++;
    ...
    if(localStorage.getItem("foodStyle") === "img000food") {
      food_id_000 = getStoredNumber("food000Storage");
      food_id_000++;
    ...
    if(localStorage.getItem("foodStyle") === "img001food") {
      food_id_001 = getStoredNumber("food001Storage");
      food_id_001++;
    ...
    if(localStorage.getItem("foodStyle") === "img002food") {
      food_id_002 = getStoredNumber("food002Storage");
      food_id_002++;
    ...
    if(localStorage.getItem("foodStyle") === "img003food") {
      food_id_003 = getStoredNumber("food003Storage");
      food_id_003++;
    ...
    if(localStorage.getItem("foodStyle") === "img004food") {
      food_id_004 = getStoredNumber("food004Storage");
      food_id_004++;
    ...
    if(localStorage.getItem("foodStyle") === "img005food") {
      food_id_005 = getStoredNumber("food005Storage");
      food_id_005++;
    ...
    if(localStorage.getItem("foodStyle") === "img006food") {
      food_id_006 = getStoredNumber("food006Storage");
      food_id_006++;
    ...
    if(localStorage.getItem("foodStyle") === "img007food") {
      food_id_007 = getStoredNumber("food007Storage");
      food_id_007++;
    ...
    if(localStorage.getItem("foodStyle") === "img008food") {
      food_id_008 = getStoredNumber("food008Storage");
      food_id_008++;
    ...
    if(localStorage.getItem("foodStyle") === "img009food") {
      food_id_009 = getStoredNumber("food009Storage");
      food_id_009++;
    ...
    if(localStorage.getItem("foodStyle") === "img010food") {
      food_id_010 = getStoredNumber("food010Storage");
      food_id_010++;
    ...
    if(localStorage.getItem("foodStyle") === "img011food") {
      food_id_011 = getStoredNumber("food011Storage");
      food_id_011++;
    ...
    if(localStorage.getItem("foodStyle") === "img012food") {
      food_id_012 = getStoredNumber("food012Storage");
      food_id_012++;
    ...
    if(localStorage.getItem("foodStyle") === "img013food") {
      food_id_013 = getStoredNumber("food013Storage");
      food_id_013++;
    ...
    if(localStorage.getItem("foodStyle") === "img014food") {
      food_id_014 = getStoredNumber("food014Storage");
      food_id_014++;
    ...
    if(localStorage.getItem("foodStyle") === "img015food") {
      food_id_015 = getStoredNumber("food015Storage");
      food_id_015++;
    ...
    if(localStorage.getItem("foodStyle") === "img016food") {
      food_id_016 = getStoredNumber("food016Storage");
      food_id_016++;
    ...
    if(localStorage.getItem("foodStyle") === "img017food") {
      food_id_017 = getStoredNumber("food017Storage");
      food_id_017++;
    ...
    if(localStorage.getItem("foodStyle") === "img018food") {
      food_id_018 = getStoredNumber("food018Storage");
      food_id_018++;
    ...
    if(localStorage.getItem("foodStyle") === "img019food") {
      food_id_019 = getStoredNumber("food019Storage");
      food_id_019++;
    ...
    if(localStorage.getItem("foodStyle") === "img020food") {
      food_id_020 = getStoredNumber("food020Storage");
      food_id_020++;
    ...
    if(localStorage.getItem("foodStyle") === "img021food") {
      food_id_021 = getStoredNumber("food021Storage");
      food_id_021++;
    ...
    if(localStorage.getItem("foodStyle") === "img022food") {
      food_id_022 = getStoredNumber("food022Storage");
      food_id_022++;
    ...
    if(localStorage.getItem("foodStyle") === "img023food") {
      food_id_023 = getStoredNumber("food023Storage");
      food_id_023++;
    ...
    if(localStorage.getItem("foodStyle") === "img024food") {
      food_id_024 = getStoredNumber("food024Storage");
      food_id_024++;
    ...
    if(localStorage.getItem("foodStyle") === "img025food") {
      food_id_025 = getStoredNumber("food025Storage");
      food_id_025++;
    ...
    if(localStorage.getItem("foodStyle") === "img026food") {
      food_id_026 = getStoredNumber("food026Storage");
      food_id_026++;
    ...
    if(localStorage.getItem("foodStyle") === "img027food") {
      food_id_027 = getStoredNumber("food027Storage");
      food_id_027++;
    ...
    if(localStorage.getItem("foodStyle") === "img028food") {
      food_id_028 = getStoredNumber("food028Storage");
      food_id_028++;
    ...
    if(localStorage.getItem("foodStyle") === "img029food") {
      food_id_029 = getStoredNumber("food029Storage");
      food_id_029++;
    ...
    if(localStorage.getItem("foodStyle") === "img030food") {
      food_id_030 = getStoredNumber("food030Storage");
      food_id_030++;
    ...
    if(localStorage.getItem("foodStyle") === "img031food") {
      food_id_031 = getStoredNumber("food031Storage");
      food_id_031++;
    ...
    if(localStorage.getItem("foodStyle") === "img032food") {
      food_id_032 = getStoredNumber("food032Storage");
      food_id_032++;
    ...
    if(localStorage.getItem("foodStyle") === "img033food") {
      food_id_033 = getStoredNumber("food033Storage");
      food_id_033++;
    ...
    if(localStorage.getItem("foodStyle") === "img034food") {
      food_id_034 = getStoredNumber("food034Storage");
      food_id_034++;
    ...
    if(localStorage.getItem("foodStyle") === "img035food") {
      food_id_035 = getStoredNumber("food035Storage");
      food_id_035++;
    ...
    if(localStorage.getItem("foodStyle") === "img036food") {
      food_id_036 = getStoredNumber("food036Storage");
      food_id_036++;
    ...
    if(localStorage.getItem("foodStyle") === "img037food") {
      food_id_037 = getStoredNumber("food037Storage");
      food_id_037++;
    ...
    if(localStorage.getItem("foodStyle") === "img038food") {
      food_id_038 = getStoredNumber("food038Storage");
      food_id_038++;
    ...
    if(localStorage.getItem("foodStyle") === "img039food") {
      food_id_039 = getStoredNumber("food039Storage");
      food_id_039++;
    ...
    if(localStorage.getItem("foodStyle") === "img040food") {
      food_id_040 = getStoredNumber("food040Storage");
      food_id_040++;
    ...
    if(localStorage.getItem("foodStyle") === "img041food") {
      food_id_041 = getStoredNumber("food041Storage");
      food_id_041++;
    ...
    if(localStorage.getItem("foodStyle") === "img042food") {
      food_id_042 = getStoredNumber("food042Storage");
      food_id_042++;
    ...
    if(localStorage.getItem("foodStyle") === "img043food") {
      food_id_043 = getStoredNumber("food043Storage");
      food_id_043++;
    ...
    if(localStorage.getItem("foodStyle") === "img044food") {
      food_id_044 = getStoredNumber("food044Storage");
      food_id_044++;
    ...
    if(localStorage.getItem("foodStyle") === "img045food") {
      food_id_045 = getStoredNumber("food045Storage");
      food_id_045++;
    ...
    if(localStorage.getItem("foodStyle") === "img046food") {
      food_id_046 = getStoredNumber("food046Storage");
      food_id_046++;
    ...
    if(localStorage.getItem("foodStyle") === "img047food") {
      food_id_047 = getStoredNumber("food047Storage");
      food_id_047++;
    ...
    if(localStorage.getItem("foodStyle") === "img048food") {
      food_id_048 = getStoredNumber("food048Storage");
      food_id_048++;
    ...
    if(localStorage.getItem("foodStyle") === "img049food") {
      food_id_049 = getStoredNumber("food049Storage");
      food_id_049++;
    ...
    if(localStorage.getItem("foodStyle") === "img050food") {
      food_id_050 = getStoredNumber("food050Storage");
      food_id_050++;
    ...
    if(localStorage.getItem("foodStyle") === "img051food") {
      food_id_051 = getStoredNumber("food051Storage");
      food_id_051++;
    ...
    if(localStorage.getItem("foodStyle") === "img052food") {
      food_id_052 = getStoredNumber("food052Storage");
      food_id_052++;
    ...
    if(localStorage.getItem("foodStyle") === "img053food") {
      food_id_053 = getStoredNumber("food053Storage");
      food_id_053++;
    ...
    if(localStorage.getItem("foodStyle") === "img054food") {
      food_id_054 = getStoredNumber("food054Storage");
      food_id_054++;
    ...
    if(localStorage.getItem("foodStyle") === "img055food") {
      food_id_055 = getStoredNumber("food055Storage");
      food_id_055++;
    ...
    if(localStorage.getItem("foodStyle") === "img056food") {
      food_id_056 = getStoredNumber("food056Storage");
      food_id_056++;
    ...
    if(localStorage.getItem("foodStyle") === "img057food") {
      food_id_057 = getStoredNumber("food057Storage");
      food_id_057++;
    ...
    if(localStorage.getItem("foodStyle") === "img058food") {
      food_id_058 = getStoredNumber("food058Storage");
      food_id_058++;
    ...
    if(localStorage.getItem("foodStyle") === "img059food") {
      food_id_059 = getStoredNumber("food059Storage");
      food_id_059++;
    ...
    if(localStorage.getItem("foodStyle") === "img060food") {
      food_id_060 = getStoredNumber("food060Storage");
      food_id_060++;
    ...
    if(localStorage.getItem("foodStyle") === "img061food") {
      food_id_061 = getStoredNumber("food061Storage");
      food_id_061++;
    ...
    if(localStorage.getItem("foodStyle") === "img062food") {
      food_id_062 = getStoredNumber("food062Storage");
      food_id_062++;
    ...
    if(localStorage.getItem("foodStyle") === "img063food") {
      food_id_063 = getStoredNumber("food063Storage");
      food_id_063++;
    ...
    if(localStorage.getItem("foodStyle") === "img064food") {
      food_id_064 = getStoredNumber("food064Storage");
      food_id_064++;
    ...
    if(localStorage.getItem("foodStyle") === "img065food") {
      food_id_065 = getStoredNumber("food065Storage");
      food_id_065++;
    ...
    if(localStorage.getItem("foodStyle") === "img066food") {
      food_id_066 = getStoredNumber("food066Storage");
      food_id_066++;
    ...
    if(localStorage.getItem("foodStyle") === "img067food") {
      food_id_067 = getStoredNumber("food067Storage");
      food_id_067++;
    ...
    if(localStorage.getItem("foodStyle") === "img068food") {
      food_id_068 = getStoredNumber("food068Storage");
      food_id_068++;
    ...
    if(localStorage.getItem("foodStyle") === "img069food") {
      food_id_069 = getStoredNumber("food069Storage");
      food_id_069++;
    ...
    if(localStorage.getItem("foodStyle") === "img070food") {
      food_id_070 = getStoredNumber("food070Storage");
      food_id_070++;
    ...
    if(localStorage.getItem("foodStyle") === "img071food") {
      food_id_071 = getStoredNumber("food071Storage");
      food_id_071++;
    ...
    if(localStorage.getItem("foodStyle") === "img072food") {
      food_id_072 = getStoredNumber("food072Storage");
      food_id_072++;
    ...
    if(localStorage.getItem("foodStyle") === "img073food") {
      food_id_073 = getStoredNumber("food073Storage");
      food_id_073++;
    ...
    if(localStorage.getItem("foodStyle") === "img074food") {
      food_id_074 = getStoredNumber("food074Storage");
      food_id_074++;
    ...
    if(localStorage.getItem("foodStyle") === "img075food") {
      food_id_075 = getStoredNumber("food075Storage");
      food_id_075++;
    ...
    if(localStorage.getItem("foodStyle") === "img076food") {
      food_id_076 = getStoredNumber("food076Storage");
      food_id_076++;
    ...
    if(localStorage.getItem("foodStyle") === "img077food") {
      food_id_077 = getStoredNumber("food077Storage");
      food_id_077++;
