...
function openCollectionCenter() {
  document.getElementById("collectionCenter").style.display = "block";
};
...
function loadingClassic() {
  const animBtnClass = document.getElementById("loadClassicCon");
  animBtnClass.classList.add("active");
  if(animBtnClass.classList.contains("active")) {
    console.log("already selected classic loading")
  }else{
    selectionSound();
  }
};
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const scrollableElementI = document.getElementById('collectedItemsContent');
...
function checkSettingsChanges() {
  ...
  checkSettingCategory([
    { id: "administratorTools", localStorageValue: "true" }
  ],
    "checked",
    "adminTools"
  );
...
function checkObtineds() {
  if(localStorage.getItem("Akashic") === "geted") {
    document.getElementById("akashicSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Alborada") === "geted") {
    document.getElementById("alboradaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Andromeda") === "geted") {
    document.getElementById("andromedaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Arthur") === "geted") {
    document.getElementById("arthurSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Aurora") === "geted") {
    document.getElementById("auroraSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Boltus") === "geted") {
    document.getElementById("boltusSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Caramel") === "geted") {
    document.getElementById("caramelSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Death Knell") === "geted") {
    document.getElementById("death-knellSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Doomlight") === "geted") {
    document.getElementById("doomlightSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Dreadwolf") === "geted") {
    document.getElementById("dreadwolfSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Firefox") === "geted") {
    document.getElementById("firefoxSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Firestar") === "geted") {
    document.getElementById("firestarSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Flamenco") === "geted") {
    document.getElementById("flamencoSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Gabriel") === "geted") {
    document.getElementById("gabrielSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Gaia") === "geted") {
    document.getElementById("gaiaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Guerilla Hunter") === "geted") {
    document.getElementById("guerilla-hunteSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Hotsteel") === "geted") {
    document.getElementById("hotsteelSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Hurricane") === "geted") {
    document.getElementById("hurricaneSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("JOJO") === "geted") {
    document.getElementById("jojoSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Lancelot") === "geted") {
    document.getElementById("lancelotSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Michael") === "geted") {
    document.getElementById("michaelSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Moon Rabbit") === "geted") {
    document.getElementById("moon-rabbitSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Nebula") === "geted") {
    document.getElementById("nebulaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Neutron Star") === "geted") {
    document.getElementById("neutron-starSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Northern Knight") === "geted") {
    document.getElementById("northern-knightSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Pulsar") === "geted") {
    document.getElementById("pulsarSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Ranger") === "geted") {
    document.getElementById("rangerSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Raven") === "geted") {
    document.getElementById("ravenSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Shiranui") === "geted") {
    document.getElementById("shiranuiSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Skyfall") === "geted") {
    document.getElementById("skyfallSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Skyfire") === "geted") {
    document.getElementById("skyfireSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Skylark") === "geted") {
    document.getElementById("skylarkSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Snow Mirage") === "geted") {
    document.getElementById("snow-mirageSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Tempest") === "geted") {
    document.getElementById("tempestSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Trio of Enders") === "geted") {
    document.getElementById("trio-of-endersSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Twilight") === "geted") {
    document.getElementById("twilightSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Ventorus") === "geted") {
    document.getElementById("ventorusSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Aya") === "geted") {
    document.getElementById("ayaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Belladonna") === "geted") {
    document.getElementById("belladonnaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Cyrus") === "geted") {
    document.getElementById("cyrusSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Fran") === "geted") {
    document.getElementById("franSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Furanku") === "geted") {
    document.getElementById("furankuSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Iori") === "geted") {
    document.getElementById("ioriSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Ivan") === "geted") {
    document.getElementById("ivanSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Jaka") === "geted") {
    document.getElementById("jakaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Jiu Chong") === "geted") {
    document.getElementById("jiu-chongSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Joanna") === "geted") {
    document.getElementById("joannaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Kije") === "geted") {
    document.getElementById("kijeSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Kikina") === "geted") {
    document.getElementById("kikinaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Kizuna Ai") === "geted") {
    document.getElementById("kizuna-aiSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Lillian") === "geted") {
    document.getElementById("lillianSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Lysa") === "geted") {
    document.getElementById("lysaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Matilda") === "geted") {
    document.getElementById("matildaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Mia") === "geted") {
    document.getElementById("miaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Mila") === "geted") {
    document.getElementById("milaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Mobius") === "geted") {
    document.getElementById("mobiusSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Nighthawk") === "geted") {
    document.getElementById("nighthawkSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Ning") === "geted") {
    document.getElementById("ningSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Norma") === "geted") {
    document.getElementById("normaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Opal") === "geted") {
    document.getElementById("opalSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Purity") === "geted") {
    document.getElementById("puritySkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("RED") === "geted") {
    document.getElementById("redSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Riko") === "geted") {
    document.getElementById("rikoSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Rom") === "geted") {
    document.getElementById("romSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Serena") === "geted") {
    document.getElementById("serenaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Shin") === "geted") {
    document.getElementById("shinSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Silver Deacon") === "geted") {
    document.getElementById("silver-deaconSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Tarantula") === "geted") {
    document.getElementById("tarantulaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Vanessa") === "geted") {
    document.getElementById("vanessaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Villar") === "geted") {
    document.getElementById("villarSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Vita") === "geted") {
    document.getElementById("vitaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Yang") === "geted") {
    document.getElementById("yangSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Yulia") === "geted") {
    document.getElementById("yuliaSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Yutong") === "geted") {
    document.getElementById("yutongSkin000000").classList.remove("locked");
  ...
  if(localStorage.getItem("Zoe") === "geted") {
    document.getElementById("zoeSkin000000").classList.remove("locked");
...
function triggerVibration() {
  ...
  if (!success) {
    console.log("Vibration call failed. Ensure a user gesture triggered it.");
  }
}