...
//  var a050 = document.getElementById("");
  var a051 = document.getElementById("collectedTitleLang");
//  var a052 = document.getElementById("");
  ...
  var a083 = document.getElementById("reregUserBtn");
  var a084 = document.getElementById("regUserBtn");
  var a085 = document.getElementById("foodInvLang");
//  var a086 = document.getElementById("");
...
//    a052.innerHTML = "";
    ...
    a083.innerHTML = "Rename";
    a084.innerHTML = "Confirm";
    a085.innerHTML = "Food Collection";
//    a086.innerHTML = "";
...
//    a052.innerHTML = "";
    ...
    a083.innerHTML = "Переименовать";
    a084.innerHTML = "Подтвердить";
    a085.innerHTML = "Коллекция еды";
//    a086.innerHTML = "";
    for (let i = 0; i < a000_all.length; i++) {
...
//    a052.innerHTML = "";
    ...
    a083.innerHTML = "שינוי שם";
    a084.innerHTML = "אישור";
    a085.innerHTML = "אוסף אוכל";
//    a086.innerHTML = "";
    for (let i = 0; i < a000_all.length; i++) {
